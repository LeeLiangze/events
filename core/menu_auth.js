...
module.exports.setMenus = async (req, user_id) => {
    var sql = "select a.user_id,b.role_id,b.role_name,b.description,d.menu_id,d.parent_id,d.menu_name,d.menu_url,d.menu_icon from user_role a LEFT JOIN role b ON a.role_id =b.role_id LEFT JOIN menu_role c ON b.role_id = c.role_id LEFT JOIN menu d ON c.menu_id = d.menu_id where a.user_id=? and d.type=0 ORDER BY d.parent_id ASC,d.menu_id ASC";
